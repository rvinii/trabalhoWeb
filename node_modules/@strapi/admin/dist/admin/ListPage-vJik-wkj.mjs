...
import { e as errorsTrads, q as useCreateUserMutation, F as Form, M as MemoizedInputRenderer, k as useAdminUsers, r as useDeleteManyUsersMutation, b as Layouts, S as SearchInput, s as Filters, T as Table, P as Pagination, C as ConfirmDialog } from './index-hoTsgrwy.mjs';
...
import { M as MagicLinkCE, S as SelectRoles } from './SelectRoles-Kzqv2-TI.mjs';
...
const ModalForm = ({ onToggle }) => {
  ...
  const MagicLink = useEnterprise(
    MagicLinkCE,
    async () => (await import('./MagicLinkEE-vQcgXndx.mjs')).MagicLinkEE
  );
...
const ListPage = () => {
  const UsersListPage = useEnterprise(
    ...
    async () => (
      ...
      (await import('./ListPage-LIn0aEKt.mjs')).UserListPageEE
    )
  );
  if (!UsersListPage) {
    return null;
...
//# sourceMappingURL=ListPage-vJik-wkj.mjs.map
