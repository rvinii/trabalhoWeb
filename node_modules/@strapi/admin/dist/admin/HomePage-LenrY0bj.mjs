...
import { b as Layouts, v as ContentBox } from './index-hoTsgrwy.mjs';
...
const HomePage = () => {
  const Page2 = useEnterprise(
    ...
    async () => (await import('./HomePage-NdId9gqT.mjs')).HomePageEE
  );
  if (!Page2) {
    return null;
  }
...
//# sourceMappingURL=HomePage-LenrY0bj.mjs.map
