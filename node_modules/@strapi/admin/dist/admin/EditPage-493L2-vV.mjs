...
import { u as useField, w as useForm, x as MemoizedStringInput, F as Form, b as Layouts, B as BackButton, M as MemoizedInputRenderer } from './index-hoTsgrwy.mjs';
...
const WebhookForm = ({
  ...
  const EventTable = useEnterprise(
    EventTableCE,
    async () => (await import('./EventsTable-_BT8dIHY.mjs')).EventsTableEE
  );
...
//# sourceMappingURL=EditPage-493L2-vV.mjs.map
