  ...
  ...window.strapi.features.isEnabled(window.strapi.features.AUDIT_LOGS) ? [
    {
      path: "audit-logs",
      lazy: async () => {
        const { ProtectedListPage } = await import('./ListPage-Ggd99FLO.mjs');
        return {
  ...
  ...window.strapi.features.isEnabled(window.strapi.features.SSO) ? [
    {
      path: "single-sign-on",
      lazy: async () => {
        const { ProtectedSSO } = await import('./SingleSignOnPage-p1fTOytT.mjs');
        return {
...
const AuthPage = () => {
  ...
  const Login$1 = useEnterprise(
    Login,
    async () => (await import('./Login--GgWQano.mjs')).LoginEE
  );
  const forms = useEnterprise(
    FORMS,
    async () => (await import('./constants-jKuNcrQj.mjs')).FORMS,
    {
...
const ROUTES_CE = [
  {
    lazy: async () => {
      const { ProtectedListPage } = await import('./ListPage-rCkaHmeP.mjs');
      return {
        Component: ProtectedListPage
      };
    },
  ...
  {
    lazy: async () => {
      const { ProtectedCreatePage } = await import('./CreatePage-5WzWwepG.mjs');
      return {
  ...
  {
    lazy: async () => {
      const { ProtectedEditPage } = await import('./EditPage-7fMqo-c-.mjs');
      return {
  ...
  {
    lazy: async () => {
      const { ProtectedListPage } = await import('./ListPage-vJik-wkj.mjs');
      return {
        Component: ProtectedListPage
      };
    },
  ...
  {
    lazy: async () => {
      const { ProtectedEditPage } = await import('./EditPage-akxbKeqK.mjs');
      return {
        Component: ProtectedEditPage
      };
    },
  ...
  {
    lazy: async () => {
      const { ProtectedCreatePage } = await import('./CreatePage-hEdR3uWK.mjs');
      return {
        Component: ProtectedCreatePage
      };
    },
  ...
  {
    lazy: async () => {
      const { ProtectedEditPage } = await import('./EditPage-493L2-vV.mjs').then(n => n.b);
      return {
        Component: ProtectedEditPage
      };
    },
  ...
  {
    lazy: async () => {
      const { ProtectedListPage } = await import('./ListPage--B6TB-mt.mjs');
      return {
        Component: ProtectedListPage
      };
    },
  ...
  {
    lazy: async () => {
      const { ProtectedListView } = await import('./ListView-jrsV1wF_.mjs');
      return {
  ...
  {
    lazy: async () => {
      const { ProtectedCreateView } = await import('./CreateView-S8gDQUCt.mjs');
      return {
  ...
  {
    lazy: async () => {
      const { ProtectedEditView } = await import('./EditViewPage-zkNmb1zg.mjs');
      return {
  ...
  {
    lazy: async () => {
      const { ProtectedCreateView } = await import('./CreateView-OjaERndy.mjs');
      return {
        Component: ProtectedCreateView
      };
    },
  ...
  {
    lazy: async () => {
      const { ProtectedListView } = await import('./ListView-iCqFRGiO.mjs');
      return {
        Component: ProtectedListView
      };
    },
  ...
  {
    lazy: async () => {
      const { ProtectedEditView } = await import('./EditView-_QID3gT5.mjs');
      return {
        Component: ProtectedEditView
      };
    },
  ...
  {
    lazy: async () => {
      const { ProtectedInstalledPlugins } = await import('./InstalledPlugins-Z_uS95dC.mjs');
      return {
  ...
  {
    lazy: async () => {
      const { PurchaseAuditLogs } = await import('./PurchaseAuditLogs-8wmVhLCb.mjs');
      return {
  ...
  {
    lazy: async () => {
      const { PurchaseSingleSignOn } = await import('./PurchaseSingleSignOn-kgjD8gsd.mjs');
      return {
...
const getImmutableRoutes = () => [
  {
    path: "usecase",
    lazy: async () => {
      const { PrivateUseCasePage } = await import('./UseCasePage-b2VozaZB.mjs');
      return {
...
const getInitialRoutes = () => [
  {
    index: true,
    lazy: async () => {
      const { HomePage } = await import('./HomePage-LenrY0bj.mjs');
      return {
        Component: HomePage
      };
    }
  },
  {
    path: "me",
    lazy: async () => {
      const { ProfilePage } = await import('./ProfilePage-voofTYei.mjs');
      return {
  ...
  },
  {
    path: "marketplace",
    lazy: async () => {
      const { ProtectedMarketplacePage } = await import('./MarketplacePage-LRlL_4ys.mjs');
      return {
  ...
  },
  {
    path: "settings/*",
    lazy: async () => {
      const { Layout } = await import('./Layout-5lg6USuO.mjs');
      return {
        Component: Layout
      };
    },
    children: [
      {
        ...
        lazy: async () => {
          const { ApplicationInfoPage } = await import('./ApplicationInfoPage-AAIv_ZkF.mjs');
          return {
    ...
    const routes = [
      {
        ...
        children: [
          ...getImmutableRoutes(),
          {
            path: "/*",
            lazy: async () => {
              const { PrivateAdminLayout } = await import('./AuthenticatedLayout-J22BBdYe.mjs');
              return {
...
//# sourceMappingURL=index-hoTsgrwy.mjs.map
