  ...
  ...window.strapi.features.isEnabled(window.strapi.features.AUDIT_LOGS) ? [
    {
      path: "audit-logs",
      lazy: async () => {
        const { ProtectedListPage } = await Promise.resolve().then(() => require('./ListPage-Vf4xtn8w.js'));
        return {
  ...
  ...window.strapi.features.isEnabled(window.strapi.features.SSO) ? [
    {
      path: "single-sign-on",
      lazy: async () => {
        const { ProtectedSSO } = await Promise.resolve().then(() => require('./SingleSignOnPage-WjL8NvC5.js'));
        return {
...
const AuthPage = () => {
  ...
  const Login$1 = useEnterprise.useEnterprise(
    Login,
    async () => (await Promise.resolve().then(() => require('./Login-qr72UXGp.js'))).LoginEE
  );
  const forms = useEnterprise.useEnterprise(
    FORMS,
    async () => (await Promise.resolve().then(() => require('./constants-bgMqSKBQ.js'))).FORMS,
    {
...
const ROUTES_CE = [
  {
    lazy: async () => {
      const { ProtectedListPage } = await Promise.resolve().then(() => require('./ListPage-Hc3VZ9O3.js'));
      return {
        Component: ProtectedListPage
      };
    },
  ...
  {
    lazy: async () => {
      const { ProtectedCreatePage } = await Promise.resolve().then(() => require('./CreatePage-zzbF8IhD.js'));
      return {
  ...
  {
    lazy: async () => {
      const { ProtectedEditPage } = await Promise.resolve().then(() => require('./EditPage-OFlfNGv0.js'));
      return {
  ...
  {
    lazy: async () => {
      const { ProtectedListPage } = await Promise.resolve().then(() => require('./ListPage-GRLtmRuy.js'));
      return {
        Component: ProtectedListPage
      };
    },
  ...
  {
    lazy: async () => {
      const { ProtectedEditPage } = await Promise.resolve().then(() => require('./EditPage-gJJgatNc.js'));
      return {
        Component: ProtectedEditPage
      };
    },
  ...
  {
    lazy: async () => {
      const { ProtectedCreatePage } = await Promise.resolve().then(() => require('./CreatePage-3V_sa8A4.js'));
      return {
        Component: ProtectedCreatePage
      };
    },
  ...
  {
    lazy: async () => {
      const { ProtectedEditPage } = await Promise.resolve().then(() => require('./EditPage-8T9gBnnc.js')).then(n => n.EditPage$1);
      return {
        Component: ProtectedEditPage
      };
    },
  ...
  {
    lazy: async () => {
      const { ProtectedListPage } = await Promise.resolve().then(() => require('./ListPage-y3rcDJX1.js'));
      return {
        Component: ProtectedListPage
      };
    },
  ...
  {
    lazy: async () => {
      const { ProtectedListView } = await Promise.resolve().then(() => require('./ListView-8pEtfLsu.js'));
      return {
  ...
  {
    lazy: async () => {
      const { ProtectedCreateView } = await Promise.resolve().then(() => require('./CreateView-5EC5Yv96.js'));
      return {
  ...
  {
    lazy: async () => {
      const { ProtectedEditView } = await Promise.resolve().then(() => require('./EditViewPage-_wx5u6QJ.js'));
      return {
  ...
  {
    lazy: async () => {
      const { ProtectedCreateView } = await Promise.resolve().then(() => require('./CreateView-ZQEmP8-n.js'));
      return {
        Component: ProtectedCreateView
      };
    },
  ...
  {
    lazy: async () => {
      const { ProtectedListView } = await Promise.resolve().then(() => require('./ListView-noYLY_DM.js'));
      return {
        Component: ProtectedListView
      };
    },
  ...
  {
    lazy: async () => {
      const { ProtectedEditView } = await Promise.resolve().then(() => require('./EditView-ZJPPeal2.js'));
      return {
        Component: ProtectedEditView
      };
    },
  ...
  {
    lazy: async () => {
      const { ProtectedInstalledPlugins } = await Promise.resolve().then(() => require('./InstalledPlugins-spdwM8ub.js'));
      return {
  ...
  {
    lazy: async () => {
      const { PurchaseAuditLogs } = await Promise.resolve().then(() => require('./PurchaseAuditLogs-qxVh-U_P.js'));
      return {
  ...
  {
    lazy: async () => {
      const { PurchaseSingleSignOn } = await Promise.resolve().then(() => require('./PurchaseSingleSignOn-ovEsG_Ud.js'));
      return {
...
const getImmutableRoutes = () => [
  {
    path: "usecase",
    lazy: async () => {
      const { PrivateUseCasePage } = await Promise.resolve().then(() => require('./UseCasePage-hJH0orUl.js'));
      return {
...
const getInitialRoutes = () => [
  {
    index: true,
    lazy: async () => {
      const { HomePage } = await Promise.resolve().then(() => require('./HomePage-T2yVEfC3.js'));
      return {
        Component: HomePage
      };
    }
  },
  {
    path: "me",
    lazy: async () => {
      const { ProfilePage } = await Promise.resolve().then(() => require('./ProfilePage-Mte9RhXw.js'));
      return {
  ...
  },
  {
    path: "marketplace",
    lazy: async () => {
      const { ProtectedMarketplacePage } = await Promise.resolve().then(() => require('./MarketplacePage-yRWZ54oN.js'));
      return {
  ...
  },
  {
    path: "settings/*",
    lazy: async () => {
      const { Layout } = await Promise.resolve().then(() => require('./Layout-B3TQMQxb.js'));
      return {
        Component: Layout
      };
    },
    children: [
      {
        ...
        lazy: async () => {
          const { ApplicationInfoPage } = await Promise.resolve().then(() => require('./ApplicationInfoPage-bkWa99An.js'));
          return {
    ...
    const routes = [
      {
        ...
        children: [
          ...getImmutableRoutes(),
          {
            path: "/*",
            lazy: async () => {
              const { PrivateAdminLayout } = await Promise.resolve().then(() => require('./AuthenticatedLayout-ZAXB7o93.js'));
              return {
...
//# sourceMappingURL=index-we0DbzVF.js.map
